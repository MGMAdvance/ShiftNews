...
?>
<br>
<form method="POST" action="processador/pro-enviar.php" enctype="multipart/form-data">

  <div class="input-field col s12">
      <i class="material-icons prefix">person</i>
      <input id="first_name2" name="nome_pro" required type="text" class="validate">
  ...
  <div class="file-field input-field">
      ...
      <div class="file-path-wrapper">
        <input class="file-path validate" placeholder="Insira uma foto (640x360)" name="userfile" type="text">
      </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="input-field col s12">
      ...
      <input type="text" name="nm_user" id="autocomplete-input" class="nm_user">
  ...
  <div class="row">
    ...
    <div class="input-field col s12">
      ...
      <input type="text" name="time_id" autocomplete="off" id="autocomplete-input" class="time_id">
  ...
  <div class="row">
    ...
    <input type="text" id="dtNa" name="data_nascimento" class="data_nascimento">
  </div>

  <div class="row">
    <div class="input-field col s12">
      <i class="material-icons prefix">explore</i>
      <input id="nacio" type="text" name="nacionalidade">
  ...
  <div class="row">
    <div class="input-field col s12">
      ...
      <input id="input_text" type="text" name="cidade_natal">
  ...
  <div class="row">
    <div class="input-field col s12">
      ...
      <input id="input_text" type="text" required name="nickname" maxlength="75" data-length="75">
